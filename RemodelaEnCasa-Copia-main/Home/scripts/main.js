...
function crearCard(popular)
{
    let card = `<div class="card">
                    <a href="${popular.href}" target="_blank">
                    <div class="cont-sup">
...
function crearCardSpecial(special)
{
    let cardSpecial = `<div class="cardSpecial">
                            <a href="${special.href}" target="_blank">
                            <div class="cont-sup">
